      ...
      <div className="flex flex-col lg:flex-row gap-8 lg:gap-12">
        ...
        <div className="w-full lg:w-80 flex flex-col gap-8">
           <div className="flex flex-col gap-4">
              <label className="text-[10px] font-mono text-slate-500 uppercase tracking-widest px-2">Neuro-Link Input</label>
              <textarea 
                value={text}
                onChange={(e) => setText(e.target.value)}
                placeholder="Paste mission logs for refining..."
        ...
        <div className="flex-1 flex flex-col gap-4">
           <label className="text-[10px] font-mono text-slate-500 uppercase tracking-widest px-2">Aesthetic Readout</label>
           <div className="w-full bg-white/2 border border-white/5 rounded-2xl p-8 min-h-[400px] leading-relaxed text-lg font-serif">
              {text ? (
                ...
                <p className="text-slate-700 italic font-mono text-sm">Awaiting neural data uplink...</p>
              )}
           </div>
           
           <div className="flex justify-end">
              <p className="text-[9px] font-mono text-slate-600 uppercase tracking-widest">
                Optimized for rapid synaptic visual scanning.
              </p>
           </div>
        </div>
      </div>

      <div className="mt-8 p-10 rounded-3xl bg-sky-500/5 border border-white/5 text-center">
         <p className="text-[10px] font-mono text-slate-500 uppercase tracking-[0.4em] leading-relaxed">
           Enhanced visual coherence engine active. Neuro-processing speed increased by 40%.
         </p>
      </div>
