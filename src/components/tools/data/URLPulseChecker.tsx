    ...
    <div className="flex flex-col gap-10 md:gap-16">
      <div className="flex flex-col gap-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
           <div className="flex flex-col gap-4">
              <label className="text-[10px] font-mono text-slate-500 uppercase tracking-widest px-2">Enter URL</label>
              <textarea 
                value={url}
      ...
      <div className="flex flex-col gap-6">
        ...
        <div className="flex flex-col items-center gap-2">
          <span className="text-[10px] font-mono text-sky-500 uppercase tracking-widest">Social Media Preview</span>
          <span className="text-[9px] font-mono text-slate-500 uppercase tracking-widest">How your link appears</span>
        </div>
