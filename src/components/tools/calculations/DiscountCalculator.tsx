        ...
        <div className="flex flex-col gap-6">
          <div className="flex flex-col gap-3">
            ...
            <div className="relative group">
               <span className="absolute left-5 top-1/2 -translate-y-1/2 text-slate-500 font-mono text-lg">$</span>
               <input 
                 type="number"
                 value={originalPrice}
                 onChange={(e) => setOriginalPrice(e.target.value)}
                 placeholder="0.00"
                 className="w-full bg-black/40 border border-white/10 rounded-2xl p-5 pl-10 md:p-6 md:pl-12 font-mono text-xl text-sky-400 focus:outline-none focus:border-sky-500/50 transition-all"
               />
            </div>
          </div>
        ...
        <div className="flex flex-col justify-center gap-6">
           <div className="p-8 rounded-3xl bg-sky-500/5 border border-sky-500/10 flex flex-col items-center">
              ...
              <div className="flex items-baseline gap-2">
                 <span className="text-6xl font-bold text-white">${finalPrice.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</span>
              </div>
           </div>
           ...
           <div className="p-6 rounded-2xl bg-emerald-500/5 border border-emerald-500/10 flex flex-col items-center">
              ...
              <span className="text-2xl font-bold text-emerald-400">${savings.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</span>
           </div>
        </div>
      </div>
