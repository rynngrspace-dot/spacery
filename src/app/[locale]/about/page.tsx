      ...
      <div className="max-w-5xl w-full">
        <div className="dossier-element flex flex-col md:flex-row items-center gap-16 mb-32">
          ...
          <div className="flex-1 text-center md:text-left">
            <span className="text-xs font-mono text-sky-500 uppercase tracking-[0.4em] mb-4 block">{t("dossier")}</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-32">
          {[
            { label: t("stats.hustle.label"), value: t("stats.hustle.value") },
            { label: t("stats.orbit.label"), value: t("stats.orbit.value") },
